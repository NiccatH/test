...
},{"./modules/animations":4,"./modules/header/index.js":7,"./modules/init-move-to":10,"./modules/init-splitter":11,"./modules/loader":12,"./modules/maps/init-maps.js":18,"./modules/modals/init-modals":25,"./utils/ios-vh-fix":30}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/page-scroller.js":32,"../../vendor/scroll-trigger.js":35}],3:[function(require,module,exports){
"use strict";
...
},{"../../utils/page-scroller.js":32,"../../vendor/scroll-trigger.js":35}],6:[function(require,module,exports){
"use strict";
...
},{"../../utils/observers":31,"../../vendor/scroll-trigger.js":35}],7:[function(require,module,exports){
"use strict";
...
},{"../../utils/observers.js":31,"./set-header-height.js":8,"./toggle-menu.js":9}],8:[function(require,module,exports){
"use strict";
...
},{"../../utils/observers.js":31}],10:[function(require,module,exports){
"use strict";
...
},{"../utils/observers":31,"../utils/page-scroller.js":32,"../vendor/scroll-to-plugin":34}],11:[function(require,module,exports){
"use strict";
...
},{"../vendor/splitting":36}],12:[function(require,module,exports){
"use strict";
...
},{"../utils/scroll-lock":33}],13:[function(require,module,exports){
"use strict";
...
},{"../../utils/fetch.js":27,"./init-map-clusters.js":13}],17:[function(require,module,exports){
"use strict";
...
},{"./map-1.js":19,"./map-2.js":20,"./map-3.js":21,"./map-4.js":22,"./map-5.js":23,"./map-6.js":24}],19:[function(require,module,exports){
"use strict";
...
},{"./init-map-pin.js":15}],20:[function(require,module,exports){
"use strict";
...
var initMap5 = function initMap5(mapBlock) {
  ...
  var addMarker = function addMarker(myMap, coordinates, hintContent) {
    var marker = new ymaps.Placemark(coordinates, {
      hintContent: hintContent
    });
    myMap.geoObjects.add(marker);
  };
  var addGeoObject = function addGeoObject(map, sss, aaa) {
    var geoObject = new ymaps.GeoObject(sss, aaa);
  ...
  window.ymaps.ready(function () {
    ...
    ymaps.borders.load('001', {
      ...
      var cheSlovakiaBorders = _toConsumableArray(new Set([].concat(_toConsumableArray(result.features.find(function (feature) {
      ...
      var cheSlovakiaNeighbours = result.features.filter(function (feature) {
      ...
      var nearNeigbors = [];
      var outerNeighbors = [];
      cheSlovakiaNeighbours.forEach(function (feature) {
        var neighborCountries = feature.properties.neighbors.filter(function (iso3166) {
          return !cheSlovakiaBorders.includes(iso3166);
        });
      ...
      nearNeigbors.forEach(function (iso3166) {
        var neighborFeature = result.features.find(function (feature) {
          return feature.properties.iso3166 === iso3166;
        });
        var nearNeighborGeometry = new ymaps.GeoObject({
          geometry: {
            type: 'Polygon',
            coordinates: neighborFeature.geometry.coordinates
          },
      ...
      result.features.forEach(function (feature) {
        if (feature.properties.iso3166 === 'CZ' || feature.properties.iso3166 === 'SK') {
          ...
          var otherCountryGeometry = new ymaps.GeoObject({
            geometry: {
              type: 'Polygon',
      ...
      var customCountry = new ymaps.GeoObject({
        geometry: {
          type: 'Polygon',
      ...
      var splitterGeometry = new ymaps.GeoObject({
        geometry: {
          type: 'Polygon',
          coordinates: customGeometry
        },
...
var initMap6 = function initMap6(mapBlock) {
  ...
  window.ymaps.ready(function () {
    ...
    var pragueMarker = new ymaps.Placemark([50.0755, 14.4378], {
      hintContent: 'Prague'
    });
    var bratislavaMarker = new ymaps.Placemark([48.1486, 17.1077], {
    ...
    ymaps.borders.load('001', {
      ...
      var czFeature = result.features.find(function (feature) {
        return feature.properties.iso3166 === 'CZ';
      });
      console.log(czFeature);
      var czGeometry = czFeature.geometry.coordinates;
      var czProperties = czFeature.properties;
      czGeometry.forEach(function (regionGeometry) {
        // Create a GeoObject for each region of the Czech Republic
        var regionGeoObject = new ymaps.GeoObject({
          geometry: {
            type: 'Polygon',
...
},{"../../utils/focus-lock":28,"../../utils/scroll-lock":33}],27:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":29}],34:[function(require,module,exports){
"use strict";
