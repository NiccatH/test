...
},{"./modules/animations":4,"./modules/header/index.js":7,"./modules/init-move-to":10,"./modules/init-splitter":11,"./modules/loader":12,"./modules/maps/init-maps.js":20,"./modules/modals/init-modals":28,"./utils/ios-vh-fix":33}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/page-scroller.js":35,"../../vendor/scroll-trigger.js":38}],3:[function(require,module,exports){
"use strict";
...
},{"../../utils/page-scroller.js":35,"../../vendor/scroll-trigger.js":38}],6:[function(require,module,exports){
"use strict";
...
},{"../../utils/observers":34,"../../vendor/scroll-trigger.js":38}],7:[function(require,module,exports){
"use strict";
...
},{"../../utils/observers.js":34,"./set-header-height.js":8,"./toggle-menu.js":9}],8:[function(require,module,exports){
"use strict";
...
},{"../../utils/observers.js":34}],10:[function(require,module,exports){
"use strict";
...
},{"../utils/observers":34,"../utils/page-scroller.js":35,"../vendor/scroll-to-plugin":37}],11:[function(require,module,exports){
"use strict";
...
},{"../vendor/splitting":39}],12:[function(require,module,exports){
"use strict";
...
},{"../utils/scroll-lock":36}],13:[function(require,module,exports){
"use strict";
...
var initClustersPins = function initClustersPins(mapBlock, ymap) {
  var pinsArray = []; //  заводим пустой массив
...
var initMapFilter = function initMapFilter(mapBlock) {
  var list = document.querySelector('.map-filter'); //ищем блок филтрации

  var getMapFilter = function getMapFilter(element) {
    var allPins = ymaps.geoQuery(mapBlock.geoObjects); //ищем пины этой карты
    if (element === 'all') {
...
exports.initMapPane = void 0;
var initMapPane = function initMapPane(color, map) {
...
exports.initMapPane = initMapPane;
...
var pinSize; //переменная для записи значения
var offsetPin; //переменная для записи значения
var pinContentLayout; //переменная для записи значения
...
var initMapPin = function initMapPin(mapBlock, ymap, pin) {
  var placeCords = mapBlock.dataset.center.split(','); //координата пина , совпадает с координатой центра на карте
  ...
  var MyPlacemarkContentLayout = window.ymaps.templateLayoutFactory.createClass(pinContentLayout); //создает кастомный класс для отрисовки , сам темплейт записан в глобальную переменню после вызова одной из функций рендера пина

  // eslint-disable-next-line no-undef
  var myPlacemark = new window.ymaps.Placemark(placeCords, null, {
    placemarkType: 'mainPin',
    //устанавливаем тип пина
    iconLayout: 'default#imageWithContent',
    //так как мы используем темплейт , а не просто иконку выбираем данный параметр
    iconImageHref: '',
    // Прячет стандартую иконку, в темплейте мы используем спрайт
    iconContentSize: pinSize,
    //размерность иконки берет из заведенной глобальной переменной , в которую происходит записиь при вызове одного из двух рендеров
    iconContentOffset: offsetPin,
    //оффсет пина, все так же как и с параметром выше
    iconContentLayout: MyPlacemarkContentLayout,
    //все так же из глобальной переменной
...
var initCategoryPins = function initCategoryPins(mapBlock, ymap) {
  ...
  (0, _fetch.fetchApi)(requestURL, onSuccess); //запускаем функцию фетча , если данные успешно получены запускается функция onSuccess
};
exports.initCategoryPins = initCategoryPins;

},{"../../utils/fetch.js":30,"./init-map-clusters.js":13}],18:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.processNeighbors = exports.initCheSlov = void 0;
var addGeoObject = function addGeoObject(map, paramOptions, decorOptions) {
  var geoObject = new ymaps.GeoObject(paramOptions, decorOptions);
  map.geoObjects.add(geoObject);
};
var processNeighbor = function processNeighbor(iso3166, result, map, decorOptions) {
  var neighborFeature = result.features.find(function (feature) {
    return feature.properties.iso3166 === iso3166;
  });
  var paramOptions = {
    geometry: {
      type: 'Polygon',
...
var processZone = function processZone(map, coordinates, properties, decorOptions) {
  var paramOptions = {
    geometry: {
      type: 'Polygon',
...
var initCheSlov = function initCheSlov(arr, map, coordinates, properties) {
  arr.forEach(function (el) {
    processZone(map, coordinates, properties, el.decorOptions);
  });
};
exports.initCheSlov = initCheSlov;
var processNeighbors = function processNeighbors(neighbors, decorOptions, result, map) {
  neighbors.forEach(function (iso3166) {
    processNeighbor(iso3166, result, map, decorOptions);
  });
};
exports.processNeighbors = processNeighbors;
...
var initZoomMap = function initZoomMap(ymap) {
  var messageBlock = document.querySelector('.ya-map__message'); //находим блок сообщения

  if (!messageBlock) {
    return;
  } //если нет останавливаем дальнешие действия

  var CTRL_KEY = 'Control'; // кнопка
  var TIMEOUT = 1500; //значение таймаута
  var isCtrlKeyDown; //переменная состояния true или false
  var isCtrlMessageVisible; //переменная состояния true или false
...
var _map5 = require("./map-5.js");
var _map6 = require("./map-6.js");
...
var initSetupMap = function initSetupMap(mapId, mapBlock) {
  switch (mapId) {
    case 'map-6':
      (0, _map6.initMap6)(mapBlock);
      break;
    case 'map-5':
      (0, _map5.initMap5)(mapBlock);
      break;
    case 'map-4':
...
var initMaps = function initMaps() {
  var mapBlocks = document.querySelectorAll('.ya-map__map'); //ищем все обертки куда добавляется карта
...
},{"./map-1.js":22,"./map-2.js":23,"./map-3.js":24,"./map-4.js":25,"./map-5.js":26,"./map-6.js":27}],21:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initSimplePins = void 0;
var initSimplePins = function initSimplePins(pins, map) {
  var addMarker = function addMarker(coordinates, hintContent) {
...
exports.initSimplePins = initSimplePins;
...
var initMap1 = function initMap1(mapBlock) {
  var center = mapBlock.dataset.center.split(', ').map(function (str) {
    return +str;
  }); //создает массив из строки дата атра
  var zoom = +mapBlock.dataset.zoom; //значение зум из датасета
  var controls = mapBlock.dataset.controls ? mapBlock.dataset.controls.split(' ') : []; //опционально создает массив из контролов , если они есть в дата атр
  var behaviorsMap = ['drag', 'multiTouch']; //включает мультитач и перемещалку(перетаскивание)

  window.ymaps.ready(function () {
    var myMap = new ymaps.Map(mapBlock, {
      center: center,
      //параметр центра координат
      zoom: zoom,
      //зуум
      controls: controls,
      //у нас он будет пустым , тк в дата атр ничего нет
      behaviors: behaviorsMap //отвечает за интерактивность
    }, {
      autoFitToViewport: 'always' //авторазмерность
    });

    (0, _initMapPin.initMapPin)(mapBlock, myMap); //отрисовка пина в данном случае не передаем 'small' третьим параметром для отрисовки дефолт пина
  });
};
exports.initMap1 = initMap1;

},{"./init-map-pin.js":16}],23:[function(require,module,exports){
"use strict";
...
var initMap2 = function initMap2(mapBlock) {
  ...
  window.ymaps.ready(function () {
    ...
    (0, _initMapPin.initMapPin)(mapBlock, myMap, 'small'); //отрисовка пина в данном случае передаем 'small' третьим параметром для отрисовки малого пина
    (0, _initMapPins.initCategoryPins)(mapBlock, myMap); //отрисовка категорий
  });
};
exports.initMap2 = initMap2;

},{"./init-map-pin.js":16,"./init-map-pins.js":17}],24:[function(require,module,exports){
"use strict";
...
var initMap3 = function initMap3(mapBlock) {
  ...
  window.ymaps.ready(function () {
    ...
    (0, _initMapPin.initMapPin)(mapBlock, myMap, 'small'); //отрисовка пина в данном случае передаем 'small' третьим параметром для отрисовки малого пина
    (0, _initMapPins.initCategoryPins)(mapBlock, myMap); //отрисовка категорий
    (0, _initMapFilter.initMapFilter)(myMap); //инициализирует инпуты фильтрации
    (0, _initMapZoom.initZoomMap)(myMap); //инизиализирует поведение по зуму для десктопа включает зум по контролу , на мобильном снимает слушаетля на эти события
  });
};
exports.initMap3 = initMap3;

},{"./init-map-filter.js":14,"./init-map-pin.js":16,"./init-map-pins.js":17,"./init-map-zoom.js":19}],25:[function(require,module,exports){
"use strict";
...
var initMap4 = function initMap4(mapBlock) {
  ...
  window.ymaps.ready(function () {
    ...
    (0, _initMapPin.initMapPin)(mapBlock, myMap, 'small'); //отрисовка пина в данном случае передаем 'small' третьим параметром для отрисовки малого пина
    (0, _initMapPins.initCategoryPins)(mapBlock, myMap); //отрисовка пинов категории, кластеры зашиты внуть при условии что мэмблок будет иметь дата атр кластер
    (0, _initMapZoom.initZoomMap)(myMap); //инициализации зума
  });
};
exports.initMap4 = initMap4;

},{"./init-map-pin.js":16,"./init-map-pins.js":17,"./init-map-zoom.js":19}],26:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initMap5 = void 0;
var _initMapZonesFill = require("./init-map-zones-fill");
var _initSimplePins = require("./init-simple-pins");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var initMap5 = function initMap5(mapBlock) {
  var center = mapBlock.dataset.center.split(', ').map(function (str) {
    return +str;
  });
  ...
  window.ymaps.ready(function () {
    ...
    (0, _initSimplePins.initSimplePins)(markers, myMap);
    ymaps.borders.load('001', {
      lang: 'ru',
      quality: 2
    }).then(function (result) {
      var allCountries = result.features.map(function (feature) {
        return feature.properties.iso3166;
      });
      var cheSlovAndNearNeigbors = _toConsumableArray(new Set([].concat(_toConsumableArray(result.features.find(function (feature) {
        return feature.properties.iso3166 === 'CZ';
      }).properties.neighbors), _toConsumableArray(result.features.find(function (feature) {
        return feature.properties.iso3166 === 'SK';
      }).properties.neighbors))));
      var nearNeigbors = [];
      var outerNeighbors = [];
      var cheSlovakiaNeighboursFeatures = result.features.filter(function (feature) {
        var iso3166 = feature.properties.iso3166;
        return cheSlovAndNearNeigbors.includes(iso3166) && iso3166 !== 'CZ' && iso3166 !== 'SK';
      });
      cheSlovakiaNeighboursFeatures.forEach(function (feature) {
        var neighborCountries = feature.properties.neighbors.filter(function (iso3166) {
          return !cheSlovAndNearNeigbors.includes(iso3166);
        });
        outerNeighbors.push.apply(outerNeighbors, _toConsumableArray(neighborCountries));
        nearNeigbors.push(feature.properties.iso3166);
      });
      var uniqueOuterNeigbors = _toConsumableArray(new Set(outerNeighbors));
      var cheSlovAndAllNeighbors = [].concat(_toConsumableArray(uniqueOuterNeigbors), _toConsumableArray(cheSlovAndNearNeigbors));
      var remainingCountries = allCountries.filter(function (value) {
        return !cheSlovAndAllNeighbors.includes(value);
      }).concat(cheSlovAndAllNeighbors.filter(function (value) {
      ...
      (0, _initMapZonesFill.processNeighbors)(uniqueOuterNeigbors, outerDecor, result, myMap);
      (0, _initMapZonesFill.processNeighbors)(nearNeigbors, nearDecor, result, myMap);
      (0, _initMapZonesFill.processNeighbors)(remainingCountries, remainDecor, result, myMap);
    });
  });
};
exports.initMap5 = initMap5;

},{"./init-map-zones-fill":18,"./init-simple-pins":21}],27:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initMap6 = void 0;
var _initMapPane = require("./init-map-pane");
var _initSimplePins = require("./init-simple-pins");
var _initMapZonesFill = require("./init-map-zones-fill");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
...
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var initMap6 = function initMap6(mapBlock) {
  var center = mapBlock.dataset.center.split(', ').map(function (str) {
    return +str;
  });
  var zoom = +mapBlock.dataset.zoom;
  ...
  window.ymaps.ready(function () {
    ...
    (0, _initSimplePins.initSimplePins)(markers, myMap);
    (0, _initMapPane.initMapPane)('#808080', myMap);
    ymaps.borders.load('001', {
      lang: 'ru',
      quality: 2
    }).then(function (result) {
      ...
      result.features.forEach(function (feature) {
        if (feature.properties.iso3166 === 'CZ' || feature.properties.iso3166 === 'SK') {
          customGeometry.push.apply(customGeometry, _toConsumableArray(feature.geometry.coordinates));
        }
      });
      (0, _initMapZonesFill.initCheSlov)(newArr, myMap, customGeometry, customProperties);
    });
  });
};
exports.initMap6 = initMap6;

},{"./init-map-pane":15,"./init-map-zones-fill":18,"./init-simple-pins":21}],28:[function(require,module,exports){
"use strict";
...
},{"./modals":29}],29:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":31,"../../utils/scroll-lock":36}],30:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":32}],34:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":32}],37:[function(require,module,exports){
"use strict";
